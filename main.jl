...
# train EM model
means, covs, πk2 = train_em("models/EM/speech", data[1:nr_files], centers, πk1; nr_iterations=nr_iterations_em)

# train GS model
q_μ, q_γ, q_a = train_gs("models/GS/speech", data, means, covs, πk2; nr_iterations=nr_iterations);
