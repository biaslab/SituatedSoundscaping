...
function process_data!(data::Data, means::Array{Float64,2}, means_new::Array{Float64,2}, covs::Array{Float64,2}, covs_new::Array{Float64,2}, logπk::Array{Float64,1}, Nk::Array{Float64,1}, γ::Array{Float64,1}, it::Int64)
...
function process_data!(data::Array{Float64,2}, means::Array{Float64,2}, means_new::Array{Float64,2}, covs::Array{Float64,2}, covs_new::Array{Float64,2}, logπk::Array{Float64,1}, Nk::Array{Float64,1}, γ::Array{Float64,1}, it::Int64)
    d = zeros(size(data)) 
    total_log_likelihood_propto = 0
    dsize = [1, 1]

    # loop through files
    @showprogress "iteration "*string(it)*" - " for k in 1:1
...
function emstep!(data::Array{Float64,2}, means::Array{Float64,2}, covs::Array{Float64,2}, πk::Array{Float64,1}, it::Int64)
    nr_frequencies, nr_mixtures = size(means)
    Nk = zeros(nr_mixtures)
    γ = zeros(nr_mixtures)
    logπk = log.(πk)
