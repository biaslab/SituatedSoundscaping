...
for (ndB, nmix_speech, nmix_noise) in Iterators.product(power_noise, nr_mixtures_speech, nr_mixtures_noise)
    ...
    speech_sep = separate_sources_algonquin("exports/algonquin", mixed_signal, means_speech, covs_speech, πk2_speech, means_noise, covs_noise, πk2_noise; observation_noise_precision=observation_noise_precision, block_length=32, power_dB=ndB, save_results=true, nr_iterations=nr_iterations_vmp)
